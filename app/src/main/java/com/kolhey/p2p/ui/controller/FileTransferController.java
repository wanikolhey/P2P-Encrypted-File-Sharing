...
public class FileTransferController {
    ...
    public FileTransferController(TransferServiceManager serviceManager, ExecutorService executorService) {
    ...
    public void handleTransferEvent(FileTransferEvent event) {
